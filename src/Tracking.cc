...
namespace ORB_SLAM3
{
void Tracking::SetYoloDetections(const std::vector<Detection>& detections) {
    mvLastDetections = detections;
}

std::vector<Detection> Tracking::GetLatestDetections() {
    return mvLastDetections;
}
/**
 * @brief 跟踪线程构造函数
 * @param pSys 系统类指针
...
void Tracking::newParameterLoader(Settings *settings) {
    ...
    mpExtractorLeft->SetTrackingPtr(this);
...
mpIniExtractor->SetTrackingPtr(this);
